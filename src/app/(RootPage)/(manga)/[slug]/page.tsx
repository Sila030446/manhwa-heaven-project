  ...
  return (
    <>
      <Head>
        ...
        <title>{`${manga.title} - Read Manga Online`}</title>
        ...
        <meta name="twitter:image" content={manga.coverImageUrl} />

        {/* Additional metadata */}
        <meta
          name="author"
          content={manga.authors.map((author) => author.name).join(", ")}
        />
        <meta
          name="keywords"
          content={manga.genres.map((genre) => genre.name).join(", ")}
        />
      </Head>
